...
GeoDin Onsite has no native server/API and cannot talk directly to a GeoDin server; all integration with the back office is file-based via GeoDin ML and shared folders.
