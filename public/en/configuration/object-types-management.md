...
Fill patterns and symbols are managed as system objects via the **System** tab. For the source file formats (.SGA / .SYA), the editing and preview workflow, compilation to .SGN / .SYM, and the rules for creating new tables, see [Fill Patterns and Symbols](fill-patterns-and-symbols.md).
