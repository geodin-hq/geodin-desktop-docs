...
|---|---|---|
| 1. [Plan and export to GeoDin](plan-and-export-to-geodin.md) | ArcGIS Pro to GeoDin | Create borehole locations in ArcGIS Pro, export as Excel, import into GeoDin |
| 2. [Export to ArcGIS Pro](export-to-arcgis-pro.md) | GeoDin to ArcGIS Pro | After field data collection, export enriched data back to ArcGIS as feature classes |
| 3. [Generate reports](generate-reports.md) | GeoDin | Generate borehole log and CPT reports, export as PDF per object |
...
| 5. [Publish to ArcGIS Online](publish-to-arcgis-online.md) | ArcGIS Pro to ArcGIS Online | Publish feature layers with attached reports for web-based access |
