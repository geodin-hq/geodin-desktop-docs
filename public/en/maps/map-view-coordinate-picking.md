---
description: Displaying boreholes on a map and picking coordinates by clicking
---

# Map View and Coordinate Picking
...
For configuring the coordinate system itself (EPSG codes, the `G1_EPSG.GSD` dictionary, and in-mask transformations), see [Coordinate Systems and EPSG](coordinate-systems-and-epsg.md).
