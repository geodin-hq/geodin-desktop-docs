...
Layouts can be saved in two formats: <!-- src: transcript/forms-templates-customization#layout-editor-basics -->
...
Only GLO files appear in the Available Layouts overview. GGF files must be opened by drag-and-dropping them into GeoDin. <!-- src: transcript/forms-templates-customization#layout-editor-basics -->

### Default and custom layout folders


Default layouts ship pre-installed in `C:\ProgramData\GeoDin\Layouts\`, organized by object type (e.g., G1 has borehole logs, stiff/parameter layouts, water content vs depth, Atterberg limits). Users can add custom layout folders via `Available Layouts > + button > browse to folder` (e.g., a network share for team-wide layouts). <!-- src: transcript/forms-templates-customization#layout-editor-basics -->
...
A layout can embed another layout as a **snippet** — for example, a header/footer stored once in `Common_A4_LHF.GLO` and referenced by many templates. Changing the company logo in the snippet file automatically updates all layouts using it. <!-- src: transcript/forms-templates-customization#layout-snippets -->

In edit mode, snippets appear as green-boxed regions that cannot be edited inline. To modify a snippet, open the snippet layout file directly. Snippets can contain other snippets, and a layout can include any number of them. <!-- src: transcript/forms-templates-customization#layout-snippets -->

Snippets are linked by relative path, so keep them in the same folder (or subfolders) as the layouts using them. This ensures the relationship is preserved when moving layout folders. <!-- src: help/05/10422 -->

### Drawing layers


Layouts use multiple drawing layers, visible in the **Layer Overview** panel (lower-left corner). Layers can be toggled visible/invisible, reordered, and locked. Use separate layers to isolate fixed elements (title blocks, logos) from variable graphic elements. <!-- src: transcript/forms-templates-customization#layout-editor-basics -->

### Layout editor menu


The editor toolbar is divided into two sections: <!-- src: transcript/forms-templates-customization#layout-editor-basics -->
...
A layout list is a collection of individual layouts in a single file: <!-- src: help/05/1907 -->
...
### Property Reference: Text elements <!-- src: help/05/H0000001110, H0000001118 -->
...
### Property Reference: Font properties <!-- src: help/05/H0000001129 -->
...
> **Tip:** The superscript function does not produce correct results with every font. Use Verdana or Tahoma instead of Arial if superscript renders incorrectly. <!-- src: help/05/H0000001118 -->

### Property Reference: Line and outline properties <!-- src: help/05/H0000001268, H0000001270, H0000001355, H0000001632, H0000001633, H0000001634, H0000003264, H0000003266, H0000003270 -->
...
### Property Reference: Fill pattern and transparency <!-- src: help/05/H0000001464, H0000003147 -->
...
### Property Reference: Fill calculation <!-- src: help/05/H0000003122 -->
...
### Property Reference: Symbol fill, color, and outline <!-- src: help/05/H0000001525 -->
...
### Property Reference: Variable image <!-- src: help/05/H0000001295 -->
...
When a variable image displays a **GeoDin map**, an additional "Map" branch appears in object properties for configuring scale, map limits, legend, and scale bar. <!-- src: help/05/H0000010558 -->

### Property Reference: Inserting and managing elements <!-- src: help/05/H0000001918, H0000001919, H0000001920, H0000001921 -->
...
### Property Reference: Grouping elements <!-- src: help/05/H0000002417, H0000002419 -->
...
### Property Reference: Using palettes <!-- src: help/05/H0000003231 -->
...
### Property Reference: Importing images <!-- src: help/05/H0000003433 -->
...
### Property Reference: Importing and exporting polylines <!-- src: help/05/H0000003486, H0000003488 -->
...
### Property Reference: Projection model <!-- src: help/05/H0000003383 -->
...
### Property Reference: Cross-section alignment <!-- src: help/05/H0000003394, H0000007212, H0000007402 -->
...
### Property Reference: Join layers tool <!-- src: help/05/H0000007426 -->
...
### Property Reference: Freehand layer drawing <!-- src: help/05/H0000007430 -->
...
### Property Reference: Layout list editing <!-- src: help/05/H0000003728 -->
...
### Property Reference: Legend elements and labels <!-- src: help/05/H0000002703, H0000004271, H0000004273 -->
...
### Property Reference: Layout interface quick settings <!-- src: help/05/H0000003663, H0000003701, H0000003707, H0000004276, H0000005268, H0000005269, H0000008998, H0000008999 -->
...
### Property Reference: Axis labeling <!-- src: help/05/H0000001385, H0000001402 -->
...
### Property Reference: Data sequence connections <!-- src: help/05/H0000001605 -->
...
### Property Reference: Sample data labeling <!-- src: help/05/H0000001163 -->
...
### Property Reference: Paper format quick settings <!-- src: help/05/H0000008754 -->
...
### Property Reference: North arrow and map rotation <!-- src: help/05/H0000010576 -->
...
### Property Reference: Scale bar <!-- src: help/05/H0000010730 -->
