...
<figure><img src="../.gitbook/assets/layout_01_EN.jpg" alt="Edit Graphics button"><figcaption>The Edit Graphics button at the bottom left of the GeoDin window opens the graphics editor.</figcaption></figure>
{% endstep %}
{% step %}
...
<figure><img src="../.gitbook/assets/layout_04_EN.jpg" alt="Adding a borehole log element inside the object frame"><figcaption>Adding the Borehole log element: the tool in the left toolbar (1) and the element drawn inside the object frame (2). Its Scale, Data source, Drawing type and Text branches appear in Object Properties.</figcaption></figure>
{% endstep %}
{% step %}
...
<figure><img src="../.gitbook/assets/layout_06_EN.jpg" alt="Footer table built with line and variable text elements"><figcaption>Header/footer information added with basic graphic elements and variable text: the table at the bottom shows the project and location values (Lake Mackay Area East, AE-BH-01) pulled from the database.</figcaption></figure>
{% endstep %}
{% endstepper %}
