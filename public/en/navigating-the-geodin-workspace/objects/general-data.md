...
A new object can be accessed when ***Object***, *![All objects](.gitbook/assets/icons/all-objects.png) **All objects*** or the particular **object type** (in the example \"General borehole log\") is selected in the GeoDin object manager.
...
Normally however you will want to continue in the ![Data management](.gitbook/assets/icons/data-management.png) **\"data management\"** mask using one of the five editors: General data, Layer data, Sample data, Well design and Data sequences. Detailed information is available in the following chapters.
...
A dialog appears with options to include:

- **Layer data** — geological layers and borehole log data
...
The data sequence list shows all the data sequences that belong to the object. New data sequences are created by clicking the ![New](.gitbook/assets/icons/new.png) **New** button upon which it must be given a name.
...
[Data management](data-management.md) <!-- src: help/03/2099 -->
...
1.  For the **\"Data Source\" list, then select the column in your import table that contains the names or ID numbers of the data records to be assigned. The available contents are now displayed in the list.

The two input fields  below the lists are used to restrict the displayed entries. Only entries in which the search term exists are displayed in the lists. Clear the search entry to display all entries again. <!-- src: help/03/10898 -->
