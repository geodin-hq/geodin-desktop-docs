...
The following special icons are available for the input of the layer data:
 ...
 ![Select input form](.gitbook/assets/icons/select-input-form.png) **Input form** choice and selection of recording mask
...
The available formats are shown in the list.
...
Status required if *ParentNode=DatabaseQueries*
...
Standard SEP3 - BoreholeML 3.0.1
...
Status required if *ExportTarget=2*

***Meaning***

This parameter must be set if ExportTarget=2 was specified. It specifies the name of the target database in the GeoDin object manager. <!-- src: help/03/7079 -->
