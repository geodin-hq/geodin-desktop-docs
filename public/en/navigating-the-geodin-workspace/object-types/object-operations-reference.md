...
See [Fill Patterns and Symbols](../../configuration/fill-patterns-and-symbols.md) for the source formats (.SGA / .SYA), the editing and preview workflow, and compilation to .SGN / .SYM.
