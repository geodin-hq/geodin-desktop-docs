...
When you create a new object the **"Data management"** method automatically opens (as described in the previous section). When you want to edit an existing object, select it in the GeoDin object manager and double click the  [Data management](../../navigating-the-geodin-workspace/objects/data-management.md) method icon.
...
Please also see the help notes [Using the data entry grid](../../navigating-the-geodin-workspace/measurement-values/working-with-measurement-data.md).
