...
Um GeoDin® verwenden zu können, benötigen Sie eine gültige GeoDin® Lizenzseriennummer. Diese können Sie erhalten, indem Sie [geodin.com](www.geodin.com) besuchen und eine Lizenz erwerben oder eine Testlizenz beantragen.

{% content-ref url="https://geodin.com" %} . {% endcontent-ref %}

Vergewissern Sie sich, dass Sie über Administratorrechte auf dem Computer verfügen, auf dem Sie GeoDin® installieren möchten.
...
Das GeoDin® Setup erkennt, ob ältere Versionen von GeoDin® (GeoDin® 9.6 und GeoDin® 10) mit vorherigen Setups auf die übliche Weise installiert wurden. In diesem Fall bietet das Setup eine Update-Option, bei der die vorhandene Systemkonfiguration während des Update-Prozesses beibehalten wird.
...
Die Installationseinstellungen aus früheren Versionen sind hier für Sie zusammengefasst.
...
Der Installationsassistent kopiert die Dateien in die verschiedenen Verzeichnisse.
...
Wenn Sie GeoDin® nicht sofort nach der Installation starten möchten, deaktivieren Sie das Kontrollkästchen **GeoDin® nach Abschluss der Installation starten**.

Wenn Sie GeoDin® zum ersten Mal öffnen, können Sie Ihre Seriennummer eingeben. Für die Aktivierung Ihrer Lizenz gibt es eine separate Anleitung.
